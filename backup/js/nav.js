		...
		if($(document).scrollTop() >=valTop){
			...
			if( aux==true ){
				...
				//$( "header.large" ).fadeTo( 300 , 0, function() {
					...
					$("header.small .logo img").animate({width:'55%', padding:'15% 15%'}, 300);
		    ...
		    aux2=false;
				...
				$("header.small .logo img").animate({width:'90%', padding:'0'}, 300);
...
/*---side bar slider menu for talent--*/
        ...
        function people_slide(){
	      if( $( "#sidebar-wrapper" ).hasClass( "active" )){
           ...
           $('#sidebar-wrapper.active').css('right','250px').animate();
           /*setTimeout(function(){*/
               $(document.body).css('overflow-y', 'hidden').animate();/*},1000);*/
           }
